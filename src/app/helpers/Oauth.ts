...
export class Oauth {
    ...
    authorizeAccess(params: {
        ...
        const allowed_grant_types: OauthGrantType[] = OauthUtils.assertAvailable(
            ...
            switch (grant_type) {
                ...
                case OauthGrantType.Authorization_Code:
                    ...
                    if (OauthUtils.assertAvailable(code)) {
                        const save_state = OauthStorage.getData(
                            OauthStorage.currentOauthState
                        );
