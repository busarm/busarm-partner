...
export class Api {
     ...
     * @param callback
     * */
    public static getNewTripStatusList(callback: (status: boolean, result: TripStatusObject | string | any, responseType: ApiResponseType) => any) {
        this.performRequest({
     ...
     * @param callback
     * */
    public static getAllTripStatusList(callback: (status: boolean, result: TripStatusObject | string | any, responseType: ApiResponseType) => any) {
        this.performRequest({
            url: Urls.apiGetTripStatusList,
            cache: true,
            loadCache: true,
